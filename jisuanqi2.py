...
# 生成计算器主界面
def buju(root):
    label = Label(root, width=29, height=2, bd=5, bg='#FFFACD', anchor='se',
    ...
    button_jiecheng.grid(row=4, column=4)
    ...
    button_dengyu.grid(row=5, column=4, rowspan=3)  # rowspan：设置单元格横向跨越的行数
